        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    slug = table.Column<string>(type: "text", nullable: true, computedColumnSql: "lower(replace(title::text, ' '::text, '-'::text))", stored: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sale_price = table.Column<decimal>(type: "numeric", nullable: false, computedColumnSql: "price * (1::numeric - sale::numeric(5,2) / 100::numeric)", stored: true),
